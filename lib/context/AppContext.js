...
export const AppProvider = ({ children }) => {
  ...
  return (
    <AuthContext.Provider
      value={{
        notificationsCount,
        loadNotifications: loadNotificationsCount, // por si necesitas llamarlo manualmente
        unreadMessagesCount, 
        loadUnreadMessages: loadUnreadMessagesCount // por si necesitas llamarlo manualmente
      }}
    >
      {children}
    </AuthContext.Provider>
