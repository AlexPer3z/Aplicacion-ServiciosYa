        ...
        {servicios.length === 0 ? (
          ...
          servicios.map((servicio) => (
            <TouchableOpacity
              ...
              style={[
                styles.servicioCard,
                servicio.estado === 'pausado' && { opacity: 0.5 }
              ]}
              onPress={() => {
            ...
            >
              ...
              <Text style={styles.servicioText}>Precio: <Text style={{ color: '#19D4C6', fontWeight: 'bold' }}>{servicio.precio}</Text></Text>
            ...
            <View style={styles.modalContenido}>
              {servicioSeleccionado && (
                <>
                  ...
                  <Text style={styles.modalTexto}>Precio: <Text style={{ color: '#19D4C6', fontWeight: 'bold' }}>{servicioSeleccionado.precio}</Text></Text>
          ...
          <View style={styles.modalFondo}>
            <View style={styles.modalConfirmacion}>
              <Text style={styles.mensajeConfirmacion}>
                <Text style={{ fontSize: 24 }}>✅</Text> La propuesta fue enviada al trabajador. Ahora debes esperar que acepte la solicitud.
              </Text>
              <TouchableOpacity
