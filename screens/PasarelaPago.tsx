...
export default function PagoInicial() {
  ...
  const iniciarPago = async () => {
    ...
    try {
      ...
      if (pais === "BO") {
        vexo.pago("registro_unico", 10, "BOB"); // Register payment 10 BOB
        ...
        vexo.pago("registro_unico", 5000, "ARS"); // Register payment 5000 ARS
      ...
      {pais === "AR" ? (
        <>
          ...
          <View style={styles.contenedorPlanes}>
            <TouchableOpacity
              style={[styles.planBox, styles.botonPlan1]}
              onPress={async () => {
                vexo.pago("plan", 5000, "ARS");
